...
const HeroHome = () => {
  return (
     <section className="bg-hero min-h-175 lg:h-175">
      <div className="relative py-12 sm:py-16 lg:py-24 px-4 sm:px-6 md:mx-4 lg:mx-20 text-lg">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-18 items-center justify-center">
          ...
          <div className="lg:ml-56 flex items-center justify-center">
            <div className="relative ">
              ...
              <div className="absolute -bottom-2 lg:-bottom-4 -left-4 bg-white  text-secondary p-1 rounded-full w-56 flex justify-center items-center animate-bounce transition-all">
                <span className="font-bold">A partir de 30 000</span>/mois
              </div>
            </div>
          </div>
        </div>
